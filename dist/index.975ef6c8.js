...
const Chip8 = require("be634e1e13bf9ace");
const Monitor = require("eb884feba01e7431");
const monitor = new Monitor(document.getElementById('screen'));
const FPS = 60;
function step() {
    now = Date.now();
    elapsed = now - then;
    if (elapsed > fpsInterval) Chip8.cycle();
...
},{"eb884feba01e7431":"dBjcy","be634e1e13bf9ace":"4rkIh"}],"dBjcy":[function(require,module,exports,__globalThis) {
const COLS = 64;
const ROWS = 32;
const SCALE = 15;
class Monitor {
...
},{}],"4rkIh":[function(require,module,exports,__globalThis) {
